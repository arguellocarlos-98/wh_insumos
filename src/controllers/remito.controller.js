...
export const editarRemitoDetalle = async (req, res, next) => {
    try {
        const parametros = req.body;
        const result = await modelActualizarRemitoDetalle(parametros);
        res.json(result);
    } catch (error) {
        next(error);
    }
...
export const insertarRemitoDetalle = async (req, res, next) => {
    try {
        const parametros = req.body;
        const result = await modelInsertarRemitoDetalle(parametros);
        res.json(result);
    } catch (error) {
        next(error);
    }
...
export const listarRemitoSectoral = async (req, res, next) => {
    try {
        const parametros = req.params;
        const result = await modelListarRemitoSectorial(parametros);
        res.json(result);
    } catch (error) {
        next(error);
    }
...
export const insertarRemitoEntrada = async (req, res, next) => {
    try {
        const parametros = req.body;
        const result = await modelInsertarEncabezadoRemitoEntrada(parametros);
        res.json(result);
    } catch (error) {
        next(error);
    }
