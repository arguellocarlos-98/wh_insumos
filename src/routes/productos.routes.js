...
import { editarProducto, insertarProducto, listarProducto, mantenerProducto, cargarProductosCSV, buscarProducto, sugerenciaUnidadMedida } from "../controllers/productos.controller.js";
...
router.get("/productos/unidades/sugerencia", sugerenciaUnidadMedida);
router.get("/productos/buscar/:filtro", buscarProducto);
